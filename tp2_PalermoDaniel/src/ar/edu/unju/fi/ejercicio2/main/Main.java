...
public class Main {
	...
	public static void menu() {
		...
		System.out.println("2) Mostrar las efemerides");
		System.out.println("3) Eliminar una efemeride");
		System.out.println("4) Modificar una efemeride");
